      ...
      <div className="bg-white dark:bg-slate-900 border border-slate-200/80 dark:border-slate-800 rounded-3xl p-6 sm:p-8 shadow-sm space-y-6">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-6 border-b border-slate-100 dark:border-slate-800">
          ...
          <button
            ...
            className="self-start sm:self-center inline-flex items-center space-x-1.5 px-4 py-2 border border-slate-200 dark:border-slate-700/80 rounded-2xl text-xs font-semibold text-slate-700 dark:text-slate-200 hover:bg-slate-100 dark:hover:bg-slate-800 transition-colors min-h-[44px]"
          >
        ...
        {/* Edit Profile Form */}
        {isEditing && (
          <form onSubmit={handleSaveProfile} className="bg-slate-50 dark:bg-slate-800/60 p-5 rounded-2xl border border-slate-200/80 dark:border-slate-700/80 space-y-4 animate-fade-in">
            <div className="text-xs font-bold text-slate-900 dark:text-slate-100 uppercase font-mono tracking-wider">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-9 pr-3 py-2 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 rounded-xl text-sm text-slate-900 dark:text-slate-100 focus:outline-none focus:ring-2 focus:ring-black dark:focus:ring-white"
                  />
                </div>
              </div>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-9 pr-3 py-2 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 rounded-xl text-sm font-mono text-slate-900 dark:text-slate-100 focus:outline-none focus:ring-2 focus:ring-black dark:focus:ring-white"
                  />
                </div>
              </div>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 gap-4">
          <div className="bg-slate-50 dark:bg-slate-800/40 p-4 rounded-2xl border border-slate-200/60 dark:border-slate-800 space-y-1">
            <div className="flex items-center space-x-1.5 text-xs text-slate-500 font-mono">
              <Flame className="w-3.5 h-3.5 text-slate-900 dark:text-slate-100 fill-slate-900 dark:fill-slate-100" />
          ...
          <div className="bg-slate-50 dark:bg-slate-800/40 p-4 rounded-2xl border border-slate-200/60 dark:border-slate-800 space-y-1">
            <div className="flex items-center space-x-1.5 text-xs text-slate-500 font-mono">
              <Award className="w-3.5 h-3.5 text-slate-900 dark:text-slate-100" />
          ...
          <div className="col-span-2 sm:col-span-1 bg-slate-50 dark:bg-slate-800/40 p-4 rounded-2xl border border-slate-200/60 dark:border-slate-800 space-y-1">
            <div className="flex items-center space-x-1.5 text-xs text-slate-500 font-mono">
      ...
      <div className="bg-white dark:bg-slate-900 border border-slate-200/80 dark:border-slate-800 rounded-3xl p-6 sm:p-8 shadow-sm space-y-6">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div>
            <div className="flex items-center space-x-2 text-xs font-mono text-slate-500 mb-1">
              <Sparkles className="w-3.5 h-3.5 text-slate-900 dark:text-slate-100" />
        ...
        <div className="p-4 bg-slate-50 dark:bg-slate-800/50 rounded-2xl border border-slate-200/80 dark:border-slate-700/80 space-y-3">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-2 text-xs font-bold uppercase tracking-wider text-slate-700 dark:text-slate-300 font-mono">
              <Palette className="w-4 h-4 text-slate-900 dark:text-slate-100" />
          ...
          <div className="flex flex-wrap items-center gap-2.5 pt-1">
            ...
            <label className="relative flex items-center justify-center cursor-pointer group" title="Open Color Wheel">
              ...
              />
              <div
                className="w-9 h-9 rounded-xl border-2 border-slate-300 dark:border-slate-600 shadow-sm flex items-center justify-center transition-transform group-hover:scale-105 active:scale-95"
                style={{
                  background: 'conic-gradient(from 0deg, red, yellow, lime, cyan, blue, magenta, red)'
                }}
              >
                <div className="w-4 h-4 rounded-full bg-white dark:bg-slate-900 flex items-center justify-center shadow-xs">
                  <Palette className="w-2.5 h-2.5 text-slate-900 dark:text-slate-100" />
                </div>
              </div>
            </label>
              ...
              <button
                ...
                className={`w-8 h-8 rounded-xl transition-all border-2 flex items-center justify-center ${
                  cardBgColor.toLowerCase() === hex.toLowerCase()
                    ? 'ring-2 ring-slate-900 dark:ring-slate-100 scale-110 border-white dark:border-slate-900'
        ...
        <div className="p-4 sm:p-6 bg-slate-50 dark:bg-slate-950 rounded-2xl flex items-center justify-center border border-slate-200 dark:border-slate-800">
