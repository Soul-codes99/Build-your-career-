...
export const AdminPanel: React.FC<AdminPanelProps> = ({
  ...
  return (
    <div className="space-y-8 max-w-4xl mx-auto">
      {/* Header Banner */}
      <div className="bg-slate-900 text-white rounded-3xl p-6 sm:p-8 shadow-xl border border-slate-800 flex items-center justify-between relative overflow-hidden">
        <div className="space-y-1 relative z-10">
          <div className="flex items-center space-x-2 text-xs font-mono text-slate-100">
      ...
      <div className="bg-white dark:bg-slate-900 border border-slate-200/80 dark:border-slate-800 rounded-3xl p-6 sm:p-8 shadow-sm space-y-6">
        <div className="flex items-center justify-between pb-4 border-b border-slate-100 dark:border-slate-800">
          <h2 className="text-lg font-bold text-slate-900 dark:text-slate-100 flex items-center space-x-2">
            <Calendar className="w-5 h-5 text-slate-900 dark:text-slate-100" />
        ...
        <form onSubmit={handleSaveTask} className="space-y-4">
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            <div>
              ...
              <input
                ...
                className="w-full px-3 py-2.5 bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl text-sm font-mono text-slate-900 dark:text-slate-100 focus:outline-none focus:ring-2 focus:ring-black dark:focus:ring-white"
              />
            </div>
            ...
            <div className="sm:col-span-2">
              ...
              <input
                ...
                className="w-full px-4 py-2.5 bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl text-sm text-slate-900 dark:text-slate-100 focus:outline-none focus:ring-2 focus:ring-black dark:focus:ring-white"
              />
            </div>
          </div>
          ...
          <div className="flex items-center justify-between pt-2">
            <div>
              {taskSuccessMsg && (
                <span className="text-xs font-semibold text-slate-900 dark:text-slate-100 flex items-center space-x-1">
      ...
      <div className="bg-white dark:bg-slate-900 border border-slate-200/80 dark:border-slate-800 rounded-3xl p-6 sm:p-8 shadow-sm space-y-6">
        <div className="pb-4 border-b border-slate-100 dark:border-slate-800">
          <h2 className="text-lg font-bold text-slate-900 dark:text-slate-100 flex items-center space-x-2">
            <Search className="w-5 h-5 text-slate-900 dark:text-slate-100" />
        ...
        <div className="relative">
          ...
          <input
            ...
            className="w-full pl-10 pr-4 py-2.5 bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl text-sm text-slate-900 dark:text-slate-100 focus:outline-none focus:ring-2 focus:ring-black dark:focus:ring-white"
          />
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 max-h-60 overflow-y-auto pr-1">
          {foundUsers.map((member) => (
            <div
              ...
              className={`p-3.5 rounded-2xl border transition-all flex items-center justify-between ${
                selectedUser?.uid === member.uid
                  ? 'bg-slate-900 text-white dark:bg-slate-100 dark:text-slate-900 border-slate-900 dark:border-slate-100 shadow'
            ...
            >
              ...
              >
                <div className="w-9 h-9 rounded-full bg-slate-200 dark:bg-slate-700 text-slate-900 dark:text-slate-100 font-bold flex items-center justify-center text-xs uppercase shrink-0">
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <h3 className="text-xl font-extrabold text-slate-900 dark:text-slate-100">
                  {selectedUser.name} <span className="text-xs font-mono font-normal text-slate-500">(@{selectedUser.username})</span>
                </h3>
                <p className="text-xs text-slate-500">"{selectedUser.whatTheyDo}"</p>
              </div>
              ...
              <div className="space-y-6">
                ...
                <div className="grid grid-cols-3 gap-3">
                  <div className="p-3 bg-slate-50 dark:bg-slate-800 rounded-xl border border-slate-200 dark:border-slate-700">
                    <div className="text-[10px] text-slate-500 font-mono uppercase">Current Streak</div>
                    <div className="text-xl font-bold text-slate-900 dark:text-slate-100">{selectedUserStats.currentStreak} days</div>
                  </div>
                  <div className="p-3 bg-slate-50 dark:bg-slate-800 rounded-xl border border-slate-200 dark:border-slate-700">
                    <div className="text-[10px] text-slate-500 font-mono uppercase">Longest Streak</div>
                    <div className="text-xl font-bold text-slate-900 dark:text-slate-100">{selectedUserStats.longestStreak} days</div>
                  </div>
                  <div className="p-3 bg-slate-50 dark:bg-slate-800 rounded-xl border border-slate-200 dark:border-slate-700">
                    <div className="text-[10px] text-slate-500 font-mono uppercase">Total Completed</div>
                    <div className="text-xl font-bold text-slate-900 dark:text-slate-100">{selectedUserStats.completedTasks} tasks</div>
                  </div>
                </div>

                {/* Heatmap */}
                <div>
                  <div className="text-xs font-bold text-slate-900 dark:text-slate-100 mb-2 font-mono">
                    Member Heat Map
                  </div>
                  <HeatMap
      ...
      {userToMakeAdmin && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-950/70 backdrop-blur-sm animate-fade-in">
          <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-3xl w-full max-w-md p-6 sm:p-8 space-y-6 shadow-2xl">
            ...
            <div className="space-y-2">
              ...
              <p className="text-xs sm:text-sm text-slate-600 dark:text-slate-400 leading-relaxed">
                You are about to make <strong className="text-slate-900 dark:text-slate-100">@{userToMakeAdmin.username}</strong> ({userToMakeAdmin.name}) the group Admin.
              </p>
              <p className="text-xs text-slate-500 italic bg-slate-100 dark:bg-slate-800 p-3 rounded-xl border border-slate-200 dark:border-slate-700">
