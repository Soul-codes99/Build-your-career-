    ...
    <div className="space-y-8 max-w-4xl mx-auto">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div className="bg-white dark:bg-slate-900 border border-slate-200/80 dark:border-slate-800 rounded-3xl p-5 shadow-sm space-y-2">
          <div className="flex items-center space-x-2 text-slate-500 text-xs font-mono uppercase font-semibold">
            <Flame className="w-4 h-4 text-slate-900 dark:text-slate-100 fill-slate-900 dark:fill-slate-100" />
        ...
        <div className="bg-white dark:bg-slate-900 border border-slate-200/80 dark:border-slate-800 rounded-3xl p-5 shadow-sm space-y-2">
          <div className="flex items-center space-x-2 text-slate-500 text-xs font-mono uppercase font-semibold">
            <CheckCircle className="w-4 h-4 text-slate-900 dark:text-slate-100" />
            <span>Completed</span>
          </div>
          <div className="text-3xl font-black text-slate-900 dark:text-slate-100">
            {stats.completedTasks} <span className="text-xs font-medium text-slate-400">tasks</span>
          </div>
        </div>
        ...
        <div className="bg-white dark:bg-slate-900 border border-slate-200/80 dark:border-slate-800 rounded-3xl p-5 shadow-sm space-y-2">
          <div className="flex items-center space-x-2 text-slate-500 text-xs font-mono uppercase font-semibold">
            <Percent className="w-4 h-4 text-slate-900 dark:text-slate-100" />
          ...
          {weeklyStats.map((week, idx) => (
            ...
            >
              <div className="flex items-center justify-between">
                <span className="text-xs font-mono font-bold text-slate-900 dark:text-slate-100 flex items-center space-x-1.5">
